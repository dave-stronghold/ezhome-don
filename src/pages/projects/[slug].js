    ...
    return (
        <>
            <Head>
                ...
                <meta
                    name="description"
                    content="Construction React Next JS Template Industry, Products Manufacturing Company, building companies, architecture firms, and the like can take to their advantage by using- Construction React Next JS Template."
                />
            </Head>
            <Breadcrumb
