...
import Option from '../../../components/tabs/option';
import Finish from '../../../components/tabs/finish';
import Stain from '../../../components/tabs/stain';
function ProjectContent({ project, richTexts, projectsOverview }) {
    ...
    return (
        <Col lg={{ span: 9 }} className="pe-lg-45">
            {project.flag=='doors'&&(<div className={`${classes.banner} row g-0`}>
